...
//   // Mantendo o MODO DARK como Padrão Incial
...
//       {/* 1. ANIMAÇÃO DE ENTRADA NO TOPO (Não afeta o resto do site) */}
//       <IntroAnima />

//       {/* 2. CONTEÚDO DO SITE (Fica normalmente abaixo da intro) */}
//       <div className="portfolio-layer" style={{ position: "relative", zIndex: 10 }}>
        
//         {/* Vídeo de fundo do Portfólio normal */}
...
// --- MOCK DE DADOS - Projects ---
const projectsData = [
  { id: 1, title: "Valoriza App", tech: "React • JavaScript • Sass • NodeJS • NSQL", desc: "Plataforma completa de planejamento financeiro. Desenvolvida para auxiliar e ajudar as pessoas a economizarem e melhorarem suas vidas financeiras através desse sistema. Link demo e Git não funcionam pois não está no ar!", demo: "#", git: "#", image: "Image/Valoriza/Valoriza-1.png", imageModal: "Image/Valoriza/Valoriza-2.png" },
  { id: 2, title: "FlowState", tech: "JavaScript • HTML • BEM", desc: "Aplicação Pomodoro de produtividade. Desenvolvida para ajudar a todos a melhorarem seu jeito de estudar e evoluirem cada vez mais, projeto desenvolvido para praticar a lógica de programação na qual já tem ajudado mais de 30 pessoas!", demo: "https://lazarin123.github.io/Projeto-FlowState/", git: "https://github.com/Lazarin123/Projeto-FlowState", image: "Image/flowState/FlowState2.png", imageModal: "Image/flowState/FlowState1.png" },
  { id: 3, title: "Caixa Eletrônico - C", tech: "C", desc: "Projeto desenvolvido na Linguagem C de simulador de caixa eletrônico, na qual foi aplicado a lógica e estruturas para o sistema, um projeto na qual evolui e aprimorei meus conhecimentos em Lógica de Programação e Linguagem C", demo: "https://github.com/Lazarin123/Simulador-Caixa-Eletronico", git: "https://github.com/Lazarin123/Simulador-Caixa-Eletronico", image: "Image/caixa/Simulador-Caixa.png", imageModal: "Image/caixa/Simulador-Caixa.png" },
  { id: 4, title: "Carnivoros e Herbivoros", tech: "JavaScript • Lógica de Programação", desc: "Projeto voltado para o desenvolvimento BackEnd, de um jogo de Carnivoros e Herbivoros na qual foi aplicado a lógica de programação para o desenvolvimento do projeto!", demo: "https://github.com/Lazarin123/js_herbivores_and_carnivores", git: "https://github.com/Lazarin123/js_herbivores_and_carnivores", image: "Image/CH/Carnivoros e Herbivoros.png", imageModal: "Image/CH/Carnivoros e Herbivoros.png" },
  { id: 5, title: "My Bike - Landing Page", tech: "JavaScript • HMTL • CSS/BEM", desc: "Projeto desenvolvido para desenvolver a parte de styles como Grid, FlexBox, Positions, e praticar a lógica de programação no desenvolvimento FrontEnd Vanilla, Projeto de LandingPage para a empresa MyBike na qual evolui muito com esse desenvolvimento!", demo: "https://lazarin123.github.io/layout_landing-page/", git: "https://github.com/Lazarin123/Landing-Page", image: "Image/MyBike/MyBike.png", imageModal: "Image/MyBike/MyBike1.png" },
  { id: 6, title: "PokeDex", tech: "JavaScript • HMTL • CSS/BEM • API", desc: "Projeto desenvolvido para desenvolver a parte de styles como Grid, FlexBox, Positions, Integração de APIS e praticar a lógica de programação no desenvolvimento FrontEnd Vanilla, Projeto de PokeDex na qual evolui muito com esse desenvolvimento!", demo: "https://lazarin123.github.io/PokeDex-JS/", git: "https://github.com/Lazarin123/PokeDex-JS", image: "Image/pokedex/PokeDex2.png", imageModal: "Image/pokedex/PokeDex.1.png" },
  { id: 7, title: "Conversor de Moedas", tech: "JavaScript • HMTL • CSS/BEM • API", desc: "Projeto desenvolvido para desenvolver a parte de styles como Grid, FlexBox, Positions, Integração de APIS e praticar a lógica de programação, Projeto de Conversor de Moedas na qual conta com uma taxa de atualização de 30s para melhor experiência!", demo: "https://lazarin123.github.io/Conversor-de-Moedas-JS/", git: "https://github.com/Lazarin123/Conversor-de-Moedas-JS", image: "Image/conversor/conversor2.png", imageModal: "Image/conversor/conversor1.png" },
  { id: 8, title: "Jogo 2048", tech: "JavaScript • HMTL • CSS/BEM", desc: "Projeto desenvolvido para desenvolver a parte de styles como Grid, FlexBox, Positions, Lógica de programação, Projeto do jogo 2048 na qual conta com um jogo de quem faz mais pontos e muito bom para a evolução da lógica! Funciona apenas em Desktop (Computadores)", demo: "https://lazarin123.github.io/js_2048_game/", git: "https://github.com/Lazarin123/Projeto-Jogo-2048", image: "Image/2048/2048-1.png", imageModal: "Image/2048/2048-1.png" },
  { id: 9, title: "Buscador de CEP", tech: "JavaScript • HMTL • CSS/BEM • API", desc: "Projeto desenvolvido para desenvolver a parte de styles como Grid, FlexBox, Positions, Lógica de programação e APIs, Projeto do Buscador de CEP na qual conta com um projeto de buscador de cep aonde pratiquei minha lógica de programação e integração de APIs!", demo: "https://lazarin123.github.io/Project-Api/", git: "https://github.com/Lazarin123/Project-Api", image: "Image/cep/buscador.png", imageModal: "Image/cep/buscador.png" },
];
...
export default function App() {
  // Garantindo o Modo Dark como padrão inicial
  const [theme, setTheme] = useState(
    () => localStorage.getItem("theme") || "dark"
  );
  const [selectedProject, setSelectedProject] = useState(null);
  ...
  return (
    <div className="app-main-wrapper">
      ...
      {/* 1. INTRO ANIMA: Fica fixa na tela e some conforme o Scroll */}
      <IntroAnima />

      {/* ESPAÇADOR DA ANIMAÇÃO: Cria a barra de rolagem falsa para a animação rodar */}
      <div style={{ height: '120vh', width: '100%' }} />

      {/* 2. O SITE REAL: Inicia naturalmente APÓS o espaçador. Isso salva o layout! */}
